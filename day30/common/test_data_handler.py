...
if __name__ == '__main__':
    ...
    "data": {
        "id": 1770212524,
        "leave_amount": 1600.0,
        "mobile_phone": "13743838455",
        "reg_name": "小柠檬",
        "reg_time": "2020-12-06 09:49:27.0",
        "type": 0,
        "token_info": {
            "token_type": "Bearer",
            "expires_in": "2020-12-14 20:15:19",
            "token": "eyJhbGciOiJIUzUxMiJ9.eyJtZW1iZXJfaWQiOjE3NzAyMTI1MjQsImV4cCI6MTYwNzk0ODExOX0.uUkOISoVzVgfo7s0uiJXjwY2du_XqoU4ADEQvgunb2SY7Kp8avxQ7OHGw_G5Uyv2_QYG9MpLr92rsgIZngkj8Q",
            "second": 127.0.0.1
        }
    },
    ...
    class TestCase:
        pass
    tc = TestCase()
    maps = {"member_id": "id", "token": "token"}
    extract_data(maps, tc.__class__, json_str)
    print(dir(TestCase))
    print(TestCase.member_id, TestCase.token)
    ...
    # float_patern = '"{}":(\d+\.\d+)'
    # key = 'second'
    # pattern = float_patern.format(key)
    # print(pattern)
    # res = re.findall(pattern, json_str)
    # # pattern = '"{}":(\d+)'.format(key)
    # # print(str_pattern.format(key))
    # # res = re.findall(str_pattern.format(key), json_str)
    # print(res)
